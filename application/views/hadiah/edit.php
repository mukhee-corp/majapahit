    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Hadiah Edit</h3>
            </div>
			<?php echo form_open('hadiah/edit/'.$hadiah['id_hadiah']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="id_transaksi" class="form-control">
								...
								{
									$selected = ($transaksi['id_transaksi'] == $hadiah['id_transaksi']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="nama_barang" value="<?php echo ($this->input->post('nama_barang') ? $this->input->post('nama_barang') : $hadiah['nama_barang']); ?>" class="form-control" id="nama_barang" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="poin" value="<?php echo ($this->input->post('poin') ? $this->input->post('poin') : $hadiah['poin']); ?>" class="form-control" id="poin" />
